...
export async function getSoloDuoRank(region: LoLRegion, summonerId: string): Promise<string | undefined> {
    ...
    return `${summoner.tier[0]}${summoner.tier.slice(1).toLowerCase()} ${summoner.rank} (${summoner.leaguePoints} LP)`
}
