...
export type LeaderboardMessageLocation = { channelId: string, messageId: string }
...
export function getLeaderboardEntry(discordId: string) {
    return db.getObjectDefault<LeaderboardEntry | undefined>(leaderboardPath(discordId), undefined)
}

export function addLeaderboardEntry(discordId: string, entry: LeaderboardEntry) {
...
export function getLeaderboardMessageLocation() {
    return db.getObjectDefault<LeaderboardMessageLocation | undefined>("/messageId", undefined)
}

export function setLeaderboardMessageLocation(data: LeaderboardMessageLocation) {
