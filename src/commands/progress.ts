import { ChatInputCommandInteraction, PermissionFlagsBits, SlashCommandBuilder, bold, italic, underscore } from "discord.js"
...
export default {
    ...
    execute: async (interaction: ChatInputCommandInteraction) => {
        ...
        const fullyUpdated = Object.values(guides).every(guide => guide.season == currentSeason)
